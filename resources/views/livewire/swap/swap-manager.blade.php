<div class="space-y-6">
    ...
    <div class="bg-white rounded-lg border divide-y">
        ...
        <div wire:key="swap-{{ $req->id }}-{{ $req->status }}" wire:click="viewRequest({{ $req->id }})" class="p-4 hover:bg-gray-50 cursor-pointer">
            <div class="flex items-start justify-between gap-4">
                ...
                <div class="flex items-center gap-2" wire:click.stop>
                    ...
                    @elseif($activeTab === 'my-requests' && $req->status === 'pending')
                        <button wire:click="cancelRequest({{ $req->id }})" class="p-2 text-gray-400 hover:text-red-600 hover:bg-red-50 rounded-lg" title="Batalkan">
                ...
                <div class="p-6">
                    ...
                    <div class="mt-6 flex gap-3">
                        ...
                        @elseif($activeTab === 'my-requests' && $viewingRequest->status === 'pending')
                            ...
                            <button wire:click="cancelRequest({{ $viewingRequest->id }})" class="flex-1 px-4 py-2 bg-red-600 text-white rounded-lg text-sm font-medium hover:bg-red-700">Batalkan</button>
                        @else
