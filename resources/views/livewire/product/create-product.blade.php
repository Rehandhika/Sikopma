<div class="max-w-4xl mx-auto">
    <x-layout.page-header title="Tambah Produk" description="Buat produk baru untuk dijual">
        <x-slot:actions>
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <x-ui.card padding="true">
                    ...
                    @if(!$has_variants)
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <x-ui.input type="number" label="Stok Awal" wire:model="stock" min="0" required :error="$errors->first('stock')" />
                    ...
                    @else
                        <div class="p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg">
                            <div class="flex items-start">
                                <x-ui.icon name="information-circle" class="w-5 h-5 text-blue-600 dark:text-blue-400 mt-0.5 mr-2" />
                                <div>
                                    <h4 class="text-sm font-medium text-blue-800 dark:text-blue-300">Mode Varian Aktif</h4>
                                    <p class="text-sm text-blue-700 dark:text-blue-400 mt-1">
                                        Harga dan stok akan dikelola secara spesifik pada setiap varian di bagian bawah halaman ini.
                                    </p>
                                </div>
                            </div>
                        </div>
